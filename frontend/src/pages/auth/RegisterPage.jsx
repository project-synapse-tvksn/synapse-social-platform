...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, Code, Shield } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="text-center lg:text-left">
        ...
        <p className="text-muted-foreground">Join the next generation of social interaction.</p>
      </div>
